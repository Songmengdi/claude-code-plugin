...
**Unicode 符号在 Pencil 中可能无法正确渲染。** 使用几何形状绘制图标。

例如汉堡菜单（3 条横线）：
```
hamburger = I("navId", {"type": "frame", "width": 24, "height": 18})
I(hamburger.id, {"type": "rectangle", "width": 24, "height": 2, "fill": "#E6EDF3"})
I(hamburger.id, {"type": "rectangle", "width": 24, "height": 2, "fill": "#E6EDF3", "y": 8})
I(hamburger.id, {"type": "rectangle", "width": 24, "height": 2, "fill": "#E6EDF3", "y": 16})
```
